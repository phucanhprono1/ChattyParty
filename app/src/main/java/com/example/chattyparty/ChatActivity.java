...
import com.example.chattyparty.adapters.ChatAdapter;
import com.example.chattyparty.databinding.ActivityChatBinding;
import com.example.chattyparty.model.ChatMessage;
import com.example.chattyparty.model.User;
import com.example.chattyparty.utilities.Constants;
import com.example.chattyparty.utilities.PreferenceManager;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        ...
        if(conversionId != null){
            ...
            conversion.put(Constants.KEY_RECEIVER_IMAGE,receiverUser.avt);
    ...
    private void listenAvailabilityOfReceiver(){
        database.collection(Constants.KEY_COLLECTION_USERS).document(
                ...
                receiverUser.userId).addSnapshotListener(ChatActivity.this,(value, error) -> {
            if (error != null){
                return;
            }
            if (value != null){
